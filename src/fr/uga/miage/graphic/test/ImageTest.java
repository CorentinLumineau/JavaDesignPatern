...
class ImageTest {
    ...
    public void testAddNewItem() {
        ...
        Assertions.assertEquals(1, img.getItems().size());
    }
    ...
    public void testMoveTo() {
        ...
        Assertions.assertEquals(10, img.getP1().getX());
        Assertions.assertEquals(10, img.getP1().getY());

        img.moveTo(2,2);

        Assertions.assertEquals(12, img.getP1().getX());
        Assertions.assertEquals(12, img.getP1().getY());
    }
}
